...
- **Гибкая настройка звука цензуры:**
  ...
  - Пользовательский .wav файл — зацикливается или обрезается под длину слова (⚠️ файл должен совпадать по герцовке с обрабатываемыми файлами: 44100 или 48000 Гц)
...
7. Опционально: включи "Custom sound" и выбери свой .wav файл для замены бипа
   > ⚠️ Файл звука цензуры должен быть в той же герцовке, что и обрабатываемые аудиофайлы (44100 или 48000 Гц).
